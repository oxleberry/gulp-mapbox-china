...
$(document).ready(function() {
   ...
   L.mapbox.accessToken = 'secret_mapbox_key';
    ...
    setTimeout(function(){
        document.getElementById('instructions').className = 'class opacity';
    }, 2000);
    setTimeout(function(){
        document.getElementById('instructions').className = 'class hide';
    }, 4000);
    ...
    function intro() {
      info.innerHTML = "<h2>China, fun facts on amazing places to travels!</h2><h3>Its modern face is dazzling, but China is no one-trick pony. The world's oldest continuous civilisation isn't all smoked glass and brushed aluminium and while you won't be tripping over artefacts – three decades of round-the-clock development and rash town planning have taken their toll – rich seams of antiquity await. Serve it all up according to taste: collapsing sections of the Great Wall, temple-topped mountains, villages that time forgot, languorous water towns, sublime Buddhist grottoes and ancient desert forts. Pack a well-made pair of travelling shoes and remember the words of Laotzu: 'a journey of a thousand miles begins with a single step'.</h3><h3 class='markerText'>Click a marker on the map to see photos from each location</h3><small><a class='tutorial' href='https://www.mapbox.com/mapbox.js/example/v1.0.0/marker-tooltips-outside-map/'>Adapted from Mapbox GL JS tutorial</a></small>";
      // gulp didn't like the backticks in <div>
      // `<div class='extra'>
